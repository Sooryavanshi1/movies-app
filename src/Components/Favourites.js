...
export default class Favourates extends Component {
    constructor(){
        super()
        this.state={
            genres:[],
            ...
            <div>
               <>
                <div className="main">
                    ...
                    <div className="col-lg-9 faourites-table col-sm-12">
                        <div className="row">
                        ...
                        <thead>
                            ...
                            <th scope="col"><i class="fas fa-sort-up" onClick={this.sortPopByDesc}></i>Popularity<i class="fas fa-sort-down" onClick={this.sortPopByAsc} ></i></th>
                            <th scope="col"><i class="fas fa-sort-up" onClick={this.sortRateByDesc} ></i>Rating<i class="fas fa-sort-down"  onClick={this.sortRateByAsc}></i></th>
                            <th scope="col"></th>
                            </tr>
                        </thead>
                        <tbody>
